...
class TestOutputDisplayFunctions(unittest.TestCase):
    ...
    def test_deg(self):
        self.assertAlmostEqual(display.deg(1), math.degrees(1), 2)
        self.assertAlmostEqual(display.deg(0), math.degrees(0), 2)
        self.assertAlmostEqual(display.deg(180), math.degrees(180), 2)
        self.assertAlmostEqual(display.deg(3953), math.degrees(3953), 2)
