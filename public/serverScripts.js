...
async function calc() {
  ...
  const input = { expression: document.getElementById('resultInput').value, is_rad: document.getElementById('angleMode').checked, is_speech: document.getElementById('speechMode').checked  };
